...
import com.noodlemire.chancelpixeldungeon.actors.blobs.Foliage;
...
import com.noodlemire.chancelpixeldungeon.levels.Patch;
...
public class SecretGardenRoom extends SecretRoom
{
	...
	public void paint(Level level)
	{
		...
		level.plant(new Deadnettle.Seed(), plantPos(level));
