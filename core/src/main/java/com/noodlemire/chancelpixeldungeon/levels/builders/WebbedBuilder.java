...
package com.noodlemire.chancelpixeldungeon.levels.builders;

import com.noodlemire.chancelpixeldungeon.levels.rooms.Room;
import com.noodlemire.chancelpixeldungeon.levels.rooms.connection.ConnectionRoom;
import com.watabou.utils.PointF;
import com.watabou.utils.Random;

import java.util.ArrayList;

//Like LoopBuilder, except as many branching rooms are connected as possible
public class WebbedBuilder extends RegularBuilder
{
	...
	public WebbedBuilder setLoopShape(int exponent, float intensity, float offset)
	{
	...
	public ArrayList<Room> build(ArrayList<Room> rooms)
	{
		...
		for(Room r : rooms)
			for(Room n : r.neigbours)
				if(!n.connected.containsKey(r) && i++ % 2 == 0)
					r.connect(n);
