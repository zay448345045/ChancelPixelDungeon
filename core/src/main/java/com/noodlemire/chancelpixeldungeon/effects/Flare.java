...
public class Flare extends Visual
{
	...
	public Flare show(CharSprite visual, int cell, float duration)
	{
		return show(visual.parent, visual.worldToCamera(cell).offset(visual.width / 2, visual.height / 2), duration);
	}
