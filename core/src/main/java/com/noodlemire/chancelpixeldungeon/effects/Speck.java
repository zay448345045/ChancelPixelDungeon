...
public class Speck extends Image
{
	...
	public static final int ENTICE = 115;
	public static final int STORMCLOUD = 116;
	public static final int DARKNESS = 127;
	public static final int ORANGE_LIGHT = 118;
	public static final int YELLOW_LIGHT = 119;
	public static final int WHITE_LIGHT = 120;
	public static final int MAGMA = 121;
	public static final int PURPLE_LIGHT = 122;
