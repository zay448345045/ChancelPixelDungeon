...
package com.noodlemire.chancelpixeldungeon.effects.particles;
...
public class LeafParticle extends PixelParticle.Shrinking
{
	...
	public static final Emitter.Factory BROWN = new Factory()
	{
		@Override
		public void emit(Emitter emitter, int index, float x, float y)
		{
			LeafParticle p = ((LeafParticle) emitter.recycle(LeafParticle.class));
			p.color(ColorMath.random(0x855E0A, 0xAA7919));
			p.reset(x, y);
		}
	};
