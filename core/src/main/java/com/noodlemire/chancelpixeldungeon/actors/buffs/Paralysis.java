...
public class Paralysis extends FlavourBuff implements Expulsion
{
	...
	{
		//I have no idea how you could drink a potion of expulsion while paralyzed, but just in case, here's something to happen.
