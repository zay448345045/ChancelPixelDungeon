...
package com.noodlemire.chancelpixeldungeon.mechanics;
...
public class Ballistica
{
	...
	private static final int STOP_CHARS = 2; //ballistica will stop on first char hit
	...
	public static final int SCROLL_SPELL = STOP_TARGET | STOP_TERRAIN;
