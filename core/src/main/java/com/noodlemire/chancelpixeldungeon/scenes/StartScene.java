...
import com.noodlemire.chancelpixeldungeon.windows.WndGameInProgress;
...
public class StartScene extends PixelScene {
	...
	private static class SaveSlotButton extends Button {
		...
		protected void onClick() {
			if (newGame) {
				ChancelPixelDungeon.scene().add( new WndStartGame(slot));
			} else {
				ChancelPixelDungeon.scene().add( new WndGameInProgress(slot));
			}
		}
	}
}
