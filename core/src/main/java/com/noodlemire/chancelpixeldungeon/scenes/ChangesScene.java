...
import com.noodlemire.chancelpixeldungeon.items.stones.StoneOfEnchantment;
...
public class ChangesScene extends PixelScene {
	...
	public void create() {
		...
		changes.addButton( new ChangeButton(new ItemSprite(ItemSpriteSheet.POTION_UNSTABLE, null), "Potion Existance System",
				...
				"_-_ As for the other 16, 8 will be chosen when a run starts to be able to be generated. Essentially, individual runs will be far different from each other than they were before, down to how you use your consumables.\n" +
				"    _-_ Corrosivity (New), Enticement (New), Experience, Frost, Haste (New), Might, Overgrowth (New), " +
				"Placebo (New), Purity (Renamed from Purification.), Shielding (New), Shockwave (New), Telepathy (Renamed from Mind Vision.), " +
				"Refreshment (New), Repulsion (New), Thunderstorm (New), Toxicity (Renamed from Toxic Gas.)"));
		...
		changes.addButton( new ChangeButton(new Image(Assets.BUFFS_LARGE, 96, 32, 16, 16), "Starvation",
		...
		changes.addButton( new ChangeButton(new Image(Assets.BUFFS_LARGE, 176, 32, 16, 16), "Potion of Might",
		...
		changes.addButton( new ChangeButton(new Image(Assets.BUFFS_LARGE, 80, 32, 16, 16), "Blessed",
