...
public class WelcomeScene extends PixelScene {
	...
	private static int LATEST_UPDATE = ChancelPixelDungeon.v0_6_5;
		...
		DarkRedButton okay = new DarkRedButton(Messages.get(this, "continue")){
			...
			protected void onClick() {
				...
				if (previousVersion == 0){
					SPDSettings.version(ChancelPixelDungeon.versionCode);
	...
	private void updateVersion(int previousVersion){
		...
		if (previousVersion <= ChancelPixelDungeon.v0_6_2e){
		...
		if (previousVersion <= ChancelPixelDungeon.v0_6_0b){
