...
import com.noodlemire.chancelpixeldungeon.items.armor.curses.AntiEntropy;
import com.noodlemire.chancelpixeldungeon.items.armor.curses.Bulk;
import com.noodlemire.chancelpixeldungeon.items.armor.curses.Corrosion;
import com.noodlemire.chancelpixeldungeon.items.armor.curses.Displacement;
import com.noodlemire.chancelpixeldungeon.items.armor.curses.Metabolism;
import com.noodlemire.chancelpixeldungeon.items.armor.curses.Multiplicity;
import com.noodlemire.chancelpixeldungeon.items.armor.curses.Overgrowth;
import com.noodlemire.chancelpixeldungeon.items.armor.curses.Stench;
import com.noodlemire.chancelpixeldungeon.items.armor.glyphs.Affection;
...
import com.noodlemire.chancelpixeldungeon.items.armor.glyphs.Entanglement;
import com.noodlemire.chancelpixeldungeon.items.armor.glyphs.Flow;
import com.noodlemire.chancelpixeldungeon.items.armor.glyphs.Obfuscation;
import com.noodlemire.chancelpixeldungeon.items.armor.glyphs.Potential;
import com.noodlemire.chancelpixeldungeon.items.armor.glyphs.Repulsion;
import com.noodlemire.chancelpixeldungeon.items.armor.glyphs.Stone;
...
public class Armor extends EquipableItem
{
	...
	public Item upgrade(boolean inscribe)
	{
		...
		else if(!inscribe && !preserved() && Random.Float() > Math.pow(0.9, level()))
			inscribe(null);
	...
	{
		if(glyph != null && defender.buff(MagicImmunity.class) == null && !isBound())
	...
	public String info()
	{
		...
		if(seal != null)
			info += "\n\n" + Messages.get(this, "seal_attached");
	...
	public Item random()
	{
		switch(Random.Int(5))
		{
			...
			case 1:
				...
				break;
			case 2:
				augment = Random.Int(2) == 0 ? Augment.DEFENSE : Augment.EVASION;
				break;
			case 3:
				upgrade();
				break;
	...
	public int STRReq(int lvl)
	{
		...
		return (8 + Math.round(tier * 2)) - (int) (Math.sqrt(8 * lvl + 1) - 1) / 2 - 1;
	}
	...
	{
		return glyph != null && (glyph.getClass() == type || glyph.getClass().getSuperclass() == type)
				&& !isBound();
	}
